...
import { Tab, Tabs, Callout, Navbar, Alignment, Button } from "@blueprintjs/core";
...
class App extends React.Component{
    @observable private currentTab = Pages.Startpage;
                ...
                <div style={{display: "flex", flexDirection: "column", width: "100%", height:"100%", flex: "0 0 100%"}}>
                    <Navbar>
                        <Navbar.Group align={Alignment.LEFT}>
                            ...
                            <Navbar.Divider />
                            IT8x Lernpage - {Pages[this.currentTab]}
                        </Navbar.Group>
                    ...
                    <div style={{display: "flex", flexDirection: "row", width: "100%", flex: "0 0 100%", position: "relative"}}>
                        ...
                        <Tabs id="TabsExample" selectedTabId={this.currentTab} vertical onChange={(e) => this.currentTab = Number.parseInt(e.toString())}>
                            <Tab id={-1} disabled title="WLAN" panel={<div />} />
                            <Tab id={Pages.Startpage} title="Startseite" panel={<div />} />
                            <Tab id={Pages.Merkmal} title="Merkmal" panel={<div />} />
                            <Tab id={Pages.Frequenzen} title="Frequenzen" panel={<div />} />
                            <Tab id={Pages.Grenzen} title="Grenzen" panel={<div />} />
                            <Tab id={Pages.Konfiguration} title="Konfiguration" panel={<div />} />
                            <Tab id={Pages.Beispielszenario} title="Beispielszenario" panel={<div />} />
                            <Tabs.Expander />
                        </Tabs>
